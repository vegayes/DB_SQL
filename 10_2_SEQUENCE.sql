...
-->> 생성되자마다는 값이 없다고 생각해서  오류남
-- > CURRVAL :: 마지막 NETVAL의 값? 
...
SELECT SEQ_TEST.CURRVAL FROM DUAL; -- 2
...
INSERT INTO EMP_TEMP VALUES(SEQ_TEMP.NEXTVAL,'박길동'); -- 244
INSERT INTO EMP_TEMP VALUES(SEQ_TEMP.NEXTVAL,'최길동'); -- 245
INSERT INTO EMP_TEMP VALUES(SEQ_TEMP.NEXTVAL,'유길동'); -- 246
...
SELECT O_TEST.NEXTVAL FROM DUAL;
